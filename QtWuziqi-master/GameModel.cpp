...
void GameModel::startGame(GameType type, GameLevel level)
{
    gameType = type;
    // 初始棋盘
    gameMapVec.clear();
...
void GameModel::actionByAI(int &clickRow, int &clickCol,GameLevel level)
{
    // 计算评分
...
// 最关键的计算评分函数
void GameModel::calculateScore(GameLevel level)
{
    // 统计玩家或者电脑连成的子
                            ...
                            case NORMAL:
                                ...
                                else if (botNum == 2)
                                {
                                    if (emptyNum == 1)                // 死三
                                        ...
                                        scoreMapVec[row][col] += 200;  // 活三
                                }
                                else if (botNum == 3)
                                {
                                    if (emptyNum == 1)                // 死四
                                        scoreMapVec[row][col] += 220;
                                    else if (emptyNum == 2)
                                        scoreMapVec[row][col] += 400; // 活四
                                }
                                else if (botNum >= 4)
                                    scoreMapVec[row][col] += 40000;   // 活五
                                break;
                            case HARD:
                                if (botNum == 0)                      // 普通下子
                                    scoreMapVec[row][col] += 80;
                                else if (botNum == 1)                 // 活二
                                    scoreMapVec[row][col] += 160;
                                else if (botNum == 2)
                                {
                                    if (emptyNum == 1)                // 死三
                                        scoreMapVec[row][col] += 400;
                                    else if (emptyNum == 2)
                                        scoreMapVec[row][col] += 800;  // 活三
                                }
                                else if (botNum == 3)
                                {
                                    if (emptyNum == 1)                // 死四
                                        scoreMapVec[row][col] += 1600;
                                    else if (emptyNum == 2)
                                        scoreMapVec[row][col] += 3200; // 活四
                                }
                                else if (botNum >= 4)
                                    scoreMapVec[row][col] += 160000;   // 活五
                                break;
                            }
